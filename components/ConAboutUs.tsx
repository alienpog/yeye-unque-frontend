...
function ConAboutUs() {
  return (
    ...
    <div className=' pt-6 mb-3 md:mb-12'>
    <MiniCon>
    <SectionHeader conheader="About Us" red={false}/>
      <div className='grid grid-cols-1 mt-2 md:mt-4 md:grid-cols-2 max-w-4xl h-full mx-auto gap-4 md:gap-8'>
       <img src="/images/Rectangle 67.png" loading='lazy' alt='about_us_picture_long' className='w-full max-h-[600px] hidden md:flex'/>
        <p className='text-xs md:text-sm text-[#464646] '>
          ...
          Yeye Unique Fashion House offers an extensive range of products for women, men, and kids. From high fashion clothing to top-quality skirts, trousers, bags, and now, jewelry items, men's shoes, women's bags, and watches, our collections epitomize a harmonious blend of elegance, style, and comfort. We firmly believe that fashion should be inclusive, catering to individuals of all ages and genders, and we are committed to creating designs that resonate with a diverse clientele.
